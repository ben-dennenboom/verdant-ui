              ...
              <div class="v-z-10 v-relative">
                <div class="v-flex v-items-start v-justify-between">
                  <div class="v-relative">
                    @if($isToday)
                      <div class="v-absolute v-top-0 v-left-0 v-w-7 v-h-7 v-rounded-full"
                           style="background-color: #45BFBD;"></div>
                    @endif
                  ...
                  @if($hasEvents)
                    <div class="v-flex v-space-x-1 v-mt-1 lg:v-hidden">
                      @foreach($dayEvents as $event)
                        <span class="v-w-2.5 v-h-2.5 v-rounded-full"
      ...
      <div class="v-p-5">
        ...
        <div class="v-grid v-gap-4">
          <template x-for="(event, index) in getEvents(selectedDay)" :key="index">
            <a :href="event.link || '#'"
               class="v-flex v-items-start v-p-3 v-rounded-lg v-cursor-pointer v-no-underline hover:v-border hover:v-border-gray-300 hover:v-shadow-sm"
