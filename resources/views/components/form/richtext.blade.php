...
<div x-data="richText('{{ $name }}')"
  ...
  @if($label)
    <div class="v-flex v-items-center v-justify-between">
      <label :for="name" class="v-block v-font-medium v-text-gray-700 v-dark:v-text-gray-300">
        {{ $label }}
        @if($required)
  ...
  <div class="v-mb-2 v-border v-border-secondary-300 v-dark:v-border-gray-600 v-mt-1">
    <div class="v-flex v-items-center v-p-2 v-bg-gray-50 v-dark:v-bg-gray-700 v-border-b v-border-secondary-300 v-dark:v-border-gray-600">
      <button type="button" @click="toggleFormat('bold')"
              :class="{'v-bg-gray-200 v-dark:v-bg-gray-600': isActive('bold') }"
              class="v-p-1 hover:v-bg-gray-200 v-dark:hover:v-bg-gray-600 v-text-gray-700 v-dark:v-text-gray-300">
        <i class="fa-solid fa-bold"></i>
      </button>
      <button type="button" @click="toggleFormat('italic')"
              :class="{'v-bg-gray-200 v-dark:v-bg-gray-600': isActive('italic') }"
              class="v-p-1 v-ml-1 hover:v-bg-gray-200 v-dark:hover:v-bg-gray-600 v-text-gray-700 v-dark:v-text-gray-300">
        <i class="fa-solid fa-italic"></i>
      </button>
      <button type="button" @click="toggleFormat('underline')"
              :class="{'v-bg-gray-200 v-dark:v-bg-gray-600': isActive('underline') }"
              class="v-p-1 v-ml-1 hover:v-bg-gray-200 v-dark:hover:v-bg-gray-600 v-text-gray-700 v-dark:v-text-gray-300">
        <i class="fa-solid fa-underline"></i>
      </button>

      <div class="v-h-4 v-mx-2 v-border-l v-border-secondary-300 v-dark:v-border-gray-600"></div>
    ...
    <div x-ref="editor"
         ...
         class="richtext-editor v-px-3 v-py-2 v-min-h-[100px] focus:v-outline-none v-bg-white v-dark:v-bg-gray-800 v-text-gray-900 v-dark:v-text-gray-100"
         :required="required">
    </div>
  </div>
