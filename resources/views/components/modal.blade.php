...
<div
    ...
    style="display: none;"
>
    <div class="v-absolute v-inset-0 v-bg-surface-900 v-bg-opacity-75 v-transition-opacity"
         x-show="show"
    ...
    <div class="v-fixed v-inset-0 v-z-50 v-overflow-y-auto">
        <div class="v-flex v-min-h-full v-items-center v-justify-center v-p-4 v-text-center sm:v-p-0">
            <div
                ...
                class="v-relative v-transform v-overflow-visible v-bg-surface v-text-foreground v-text-left v-shadow-xl v-transition-all sm:v-my-8 v-w-full {{ $maxWidth }} sm:v-w-full v-rounded"
            >
                <div class="v-bg-surface v-p-4 sm:v-p-6 v-text-wrap v-rounded">
                    {{ $slot }}
                </div>
            </div>
        </div>
