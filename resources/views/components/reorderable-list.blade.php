...
<div x-data="{
    ...
    <form action="{{ $action }}" method="POST">
        ...
        <div class="v-bg-white v-border v-border-gray-200 v-p-6">
            <div class="v-text-sm v-text-gray-500 v-mb-4">
            ...
            <div class="v-space-y-2">
                @foreach($items as $index => $item)
                    <div
                        ...
                        "
                        class="v-flex v-items-center v-gap-4 v-p-4 v-bg-gray-50 v-border v-border-gray-200"
                    >
                        <input type="hidden" name="items[{{ $index }}][id]" value="{{ $item['id'] }}">

                        <div class="v-cursor-move v-text-gray-400 hover:v-text-gray-600">
                        ...
                        <div class="v-flex v-items-center v-gap-2">
                            @if($index > 0)
                                <button
                                    ...
                                    class="v-text-gray-400 hover:v-text-gray-600"
                                >
