...
<div x-data="{
    ...
    <button @click="open = !open"
            :class="isActive ?'v-text-primary-700 dark:v-text-primary-400' : 'v-text-gray-600 dark:v-text-gray-300 hover:v-text-gray-900 dark:v-hover:v-text-gray-100'"
            class="v-rounded v-flex v-items-center v-w-full v-py-3 v-px-4 hover:v-bg-gray-100 dark:v-hover:v-bg-gray-700 v-text-left v-font-medium">
