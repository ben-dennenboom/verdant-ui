...
<li class="v-list-none">
    <a href="{{ $route }}"
        {{ $attributes->merge(['class' => 'v-rounded v-flex v-items-center ' . ($active ? 'active v-bg-primary-100 v-text-primary-700' : 'v-text-gray-600') . ' v-py-3 v-px-4 hover:v-bg-gray-100 hover:v-text-gray-900']) }}>
