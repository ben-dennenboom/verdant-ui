...
export default {
  ...
  safelist: [
    {
      pattern: /^(dark:|sm:|md:|lg:|xl:|2xl:|hover:|focus:)?(bg|text|border)-(red|green|blue|orange|yellow|purple|gray|primary|secondary)-(50|100|200|300|400|500|600|700|800|900|950)$/
    },
  ],
  theme: {
    extend: {
